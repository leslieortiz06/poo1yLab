...
public class p17_TrabajandoFlotantes {
    ...
    System.out.printf("num3, num4 en formato flotante con decimales                   : %.10f  -  %.2f \n", num3,num4);
    ...
    System.out.println(String.format("\nTipo: float Min: %.1f Max: %.1f",Float.MIN_VALUE, Float.MAX_VALUE));
    System.out.println(String.format("\nTipo: double Min: %.1f Max: %.1f",Double.MIN_VALUE, Double.MAX_VALUE));
    }
}